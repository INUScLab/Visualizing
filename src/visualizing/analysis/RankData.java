...
public class RankData {
	...
	public ArrayList<ArrayList<String>> predicted_consumed_rank; // 사용량 예측량 차이
																	// 랭킹
	public ArrayList<ArrayList<String>> upper_predicted_consumed_data; // 사용량 상위
																		// 랭킹 한달
																		// 데이터
	public ArrayList<ArrayList<String>> lessconsumed_rank; // 적은사용량 랭킹
	public ArrayList<ArrayList<String>> upper_lessconsumed_data; // 적은사용량 상위 랭킹
																	// 한달 데이터

	public ArrayList<ArrayList<String>> count; // 지역 인구수

	public ArrayList<ArrayList<String>> lessconsumed_code;
	
	public ArrayList<ArrayList<String>> getLessconsumed_code() {
		return lessconsumed_code;
	}

	public void setLessconsumed_code(ArrayList<ArrayList<String>> lessconsumed_code) {
		this.lessconsumed_code = lessconsumed_code;
	}
	...
	public ArrayList<ArrayList<String>> getLessconsumed_rank() {
		return lessconsumed_rank;
	}

	public void setLessconsumed_rank(ArrayList<ArrayList<String>> lessconsumed_rank) {
		this.lessconsumed_rank = lessconsumed_rank;
	}

	public ArrayList<ArrayList<String>> getUpper_lessconsumed_data() {
		return upper_lessconsumed_data;
	}

	public void setUpper_lessconsumed_data(ArrayList<ArrayList<String>> upper_lessconsumed_data) {
		this.upper_lessconsumed_data = upper_lessconsumed_data;
	}

	/*
	 * public ArrayList<ArrayList<String>> getTest() { return consumed_rank; }
