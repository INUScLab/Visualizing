								...
								<div class="row padder">
									<div class="col-md-6">
										<section class="panel">
											<div class="tabmenu">
												<ul>
													<li><a href="#link" class="btn btn-default">시간별 조회</a>
														<ul class="tabcontent">
																	...
																	<div class="col-lg-7 form-inline">
																		<input
																			...
																			data-date-format="yyyy-mm-dd" id="edate"> <label
																			class="col-lg-3 control-label">조회</label>
																	</div>
<table class="table table-striped b-t-blue">
 ...
 %></td>
													...
													<li><a href="#link" class="btn btn-default">일별 조회</a>
														<ul class="tabcontent">
															<tr>
																<a href="#">내용 2-1</a>
															</tr>
													...
													<li><a href="#link" class="btn btn-default">월별 조회</a>
														<ul class="tabcontent">
															<li><a href="#">내용 3-1</a></li>
															<li><a href="#">내용 3-2</a></li>
														</ul>
													<li><a href="#link" class="btn btn-default">통신 이력</a>
														<ul class="tabcontent">
