             	...
             	<nav class="nav-primary hidden-xs" data-ride="collapse">
                  <ul class="nav">
                    ...
                    <li>
                      ...
                      <ul class="nav none dker">                
                        <li>
                          <a href="day-analysis.html">일별 통계</a>              
                        </li>
                        <li>
                          <a href="month-analysis.html">월별 통계</a>
                        </li>
                        <li>
                          <a href="year-analysis.html">년별 통계</a>                    
                        </li>
                        <li>
                          <a href="local-analysis.html">지역별 통계 순위</a>
                        </li>
                      </ul>
                    </li>
                    <li>
        ...
        <section class="vbox">
          ...
          <section class="scrollable m-t-xxs">
            ...
            <div class="row m-l-none m-r-none m-r-none box-shadow bg-light b-b">
              <div class="col-sm-4">
                <h3 class="m-t m-b-none text-primary font-semibold">일별 통계</h3>
            ...
            <div class="row padder">
                    ...
                    <div class="well">
                     <div class="row text-sm">
                      ...
                      <div class="col-sm-4 p-l-none">
                       <div class="form-group m-b-none">
                       <label class="col-lg-3 control-label">월</label>
                          <div class="col-lg-7 form-inline">
														<input class="input-sm input-s-sm datepicker-input form-control" type="text" value="04-02-2016" data-date-format="dd-mm-yyyy" >~<input class="input-sm input-s-sm datepicker-input form-control" type="text" value="04-02-2016" data-date-format="dd-mm-yyyy" >
                          </div>
                      </div>
                      </div>                    
                      <div class="col-sm-4 p-l-none">
                     ...
                     <div class="row text-sm">
                      ...
                      <div class="col-sm-4 p-l-none">
                        <div class="form-group">
                          <label class="col-lg-3 control-label">ddd번호</label>
                          <div class="col-lg-7">
                            <input type="text" class="form-control">
                          </div>
                        </div>
                  ...
                  <section class="panel">
                    <div class="table-responsive">
                   	  <header class="panel-heading text-primary font-semibold h5"><i class="fa fa-chevron-circle-right"></i> 2016년 2월 첫째주 (중간 타이틀 샘플)</header>
