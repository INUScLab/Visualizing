...
<%	//페이징 처리 관련
	...
	String listUrl = "/Visualizing/analysis/analysisYear.jsp";
...
<script type="text/javascript">
	...
	function pagePass (page) {
		...
		f.action = "/Visualizing/analysis/analysisYear.jsp?pageNum="+page;
		f.submit();
														...
														<div class="form-group m-b-none">
															...
															<div class="col-lg-7 form-inline">
																<input
																	...
																	data-date-format="yyyy" id="sdate">~<input
																	class="input-sm input-s-sm datepicker-input form-control"
																	type="text" name="edate" value="${param['edate']}"
																	data-date-format="yyyy" id="edate">
															</div>
														</div>
													</div>
													<div class="col-sm-4 p-l-none">
				...
				<aside class="aside-xs b-l bg-dark">
					...
					<section class="m-t-l">
						<ul class="nav nav-pills">
							...
							<li><a href="#" onclick="download_csv_analysis('년별통계')"><i class="fa fa-save icon-lg"
