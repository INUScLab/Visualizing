				...
				<section class="vbox">
					...
					<header class="dk nav-bar bg-dk-mobile visible-xs">
						<a class="btn btn-link visible-xs"
							...
							src="/Visualizing/images/logo-moblie.png" alt="수도검침서비스" /></a>
					</header>
					<!-- //모바일 로고,목록-->
					...
					<header class="dk nav-bar bg-dk-mobile shift">
						<a href="index.html" class="nav-brand "><img
							src="/Visualizing/images/logo.png" alt="수도검침서비스" /></a>
					</header>
					<!-- //웹,타블렛 -->
							...
							<nav class="nav-primary hidden-xs" data-ride="collapse">
								<ul class="nav">
									...
									<li><a href="#" class="dropdown-toggle"> <span
										...
										<ul class="nav none dker">
											<li><a href="/Visualizing/analysis/SearchDay.do">일별
													통계</a></li>
											<li><a href="/Visualizing/analysis/SearchMonth.do">월별
													통계</a></li>
											<li><a href="/Visualizing/analysis/SearchYear.do">년별
													통계</a></li>
											<li><a href="analysis/local-analysis.html">지역별 통계 순위</a></li>
										</ul></li>
									<li><a href="#" class="dropdown-toggle"> <span
											class="pull-right auto"> <i
												class="fa fa-angle-down text"></i> <i
										...
										<ul class="nav none dker">
											<li><a href="/Visualizing/report/SearchDay.do">일간
													리포트</a></li>
											<li><a href="/Visualizing/report/SearchWeek.do">주간
													리포트</a></li>
											<li><a href="/Visualizing/report/SearchMonth.do">월간
													리포트</a></li>
										</ul></li>
				...
				<section class="hbox stretch">
                  ...
                  -->
									...
									<li class="dropdown"><a class="dropdown-toggle" href="#">
											<img src="/Visualizing/images/water.png"
											data-toggle="tooltip" data-placement="bottom" title="누수"><span
											class="badge bg-danger">6</span>
									</a></li>
									<!-- 누수 end -->
									<!-- 동파 start-->
									<li class="dropdown"><a class="dropdown-toggle" href="#">
											<img src="/Visualizing/images/winter.png"
											data-toggle="tooltip" data-placement="bottom" title="동파">
									</a></li>
									<!-- 동파 end -->
									<!-- 비만 start-->
									<li class="dropdown"><a class="dropdown-toggle" href="#">
											<img src="/Visualizing/images/obesity.png"
											data-toggle="tooltip" data-placement="bottom" title="비만"><span
											class="badge bg-warning">7</span>
									</a></li>
									<!-- 비만 end -->
									<!-- 파손 start-->
									<li class="dropdown"><a class="dropdown-toggle" href="#">
											<img src="/Visualizing/images/damage.png"
											data-toggle="tooltip" data-placement="bottom" title="파손">
									</a></li>
									<!-- 파손 end -->
									<!-- 역류 start-->
									<li class="dropdown"><a class="dropdown-toggle" href="#">
											<img src="/Visualizing/images/backwash.png"
											data-toggle="tooltip" data-placement="bottom" title="역류">
									</a></li>
									<!-- 역류 end -->
									<!-- 비만 start-->
									<li class="dropdown"><a class="dropdown-toggle" href="#">
											<img src="/Visualizing/images/absence.png"
											data-toggle="tooltip" data-placement="bottom" title="부재중">
									</a></li>
									<!-- 비만 end -->
								</ul>
								<!--  nd -->
